        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a 
                href="https://wa.me/5511999999999?text=Olá! Gostaria de solicitar uma landing page." 
                target="_blank" 
                rel="noopener noreferrer"
                className="btn-brand inline-flex items-center gap-2 group"
              >
              ...
              <a 
                href="https://wa.me/5511999999999?text=Olá! Gostaria de ver os projetos da CODEMARK." 
                target="_blank" 
                rel="noopener noreferrer"
