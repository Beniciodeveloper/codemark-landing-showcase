      ...
      <div className="section-container">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <a href={project.link} target="_blank" rel="noopener noreferrer" className="bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 group block" key={project.id}>
          ...
          <div className="space-y-4">
            {!showAllProjects && (
              <div>
                <button
                  ...
                  className="bg-secondary text-primary border-2 border-primary px-8 py-3 rounded-full font-semibold hover:bg-primary hover:text-white transition-all duration-300 hover:scale-105 hover:shadow-2xl inline-flex items-center gap-2"
                >
                  Ver Mais Projetos
                  <ArrowRight size={20} />
                </button>
            ...
            <div>
              <a 
                ...
                className="bg-[#25D366] hover:bg-[#128C7E] text-white px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:scale-105 hover:shadow-2xl inline-flex items-center gap-2 group"
              >
