      ...
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white p-8 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 animate-fade-in-up group flex flex-col h-full"
            ...
            >
              ...
              <div className="border-t border-border pt-4 mt-auto">
                <a 
                  ...
                  className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white py-2 rounded-full font-medium transition-all duration-300 hover:scale-105 hover:shadow-2xl inline-flex items-center justify-center gap-2"
                >
